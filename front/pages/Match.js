...
const match = () => {
  ...
  // console.log(matchs);
  // console.log(test.battingPoints);
  // console.log(test.howManyPeopleBatted);
  ...
  console.log(bpoint);
  console.log(bpoint.battingPoints);
  const teeee = [bpoint.battingPoints];
  // setTest(bpoint.battingPoints);

  console.log(teeee);

  // console.log(test.data);

  // const H1 = test.battingPoints.homeTotalPoint;
  // const A2 = test.battingPoints.awayTotalPoint;
  // const D3 = test.battingPoints.drawTotalPoint;
  // const HM = test.howManyPeopleBatted;
